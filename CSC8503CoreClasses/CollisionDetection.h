...
namespace NCL {
	...
	public:
		...
		static Ray BuildRayFromMouse(const Camera& cam);
		static Ray BuildRayToMouse(const Camera& cam, const Vector3& from);
		...
		static Vector3*		CalculateEdgeNormal(const Transform& inTransform, const Transform& inBTransform);
